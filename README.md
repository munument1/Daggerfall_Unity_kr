...
글꼴 리소스는 퀘스트 일지와 서적을 중심으로 [부크크 명조](https://bookk.co.kr/font)를 사용하고, 나머지 슬롯에는 NEXON Warhaven을 유지합니다. Daggerfall Unity의 전역 글꼴 슬롯 구조상 일부 다른 UI에도 부크크 명조가 표시될 수 있습니다. 세부 배치와 저작권 안내는 `fonts\README_fonts.txt`를 확인하십시오.
