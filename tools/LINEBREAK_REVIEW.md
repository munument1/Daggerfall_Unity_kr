...
https://docs.google.com/spreadsheets/d/16gCOVZ-f_yMGOtB9W4jQocZCbyNPQjmwV-e00706qZY/edit
...
- 완전한 가운데 정렬 패널에서 실제 표시 행의 `<ce>` 누락
...
3. `reviewed_korean`에서 줄바꿈·공백과 필요한 `<ce>` 배치만 수정한다.
